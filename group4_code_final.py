...
#엑셀로 저장하기 위한 변수
RESULT_PATH = os.getcwd() #결과 저장할 경로
now = datetime.now() #파일이름에 현재 시간 포함
...
def main():
    info_main = input("="*50+"\n"+"입력 형식에 맞게 입력해주세요."+"\n"+" 시작하시려면 Enter를 눌러주세요."+"\n"+"="*50)
    maxpage = input("최대 크롤링할 페이지 수: ") #10,20...
    query = input("검색어 입력: ") #네이버, 대선...
    sort = input("뉴스 검색 방식 입력(관련도순=0  최신순=1  오래된순=2): ")    #관련도순=0  최신순=1  오래된순=2
    s_date = input("시작날짜 입력(2024.01.04): ")  #시작 날짜
    e_date = input("끝날짜 입력(2024.01.05): ")    #끝 날짜
